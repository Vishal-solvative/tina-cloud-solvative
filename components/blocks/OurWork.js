        ...
        <section className='section-box mt-100'>
            <div className='container'>
                <div className='text-center mb-20'>
                    <span className='tag-1 bg-6 color-green-900' data-tina-field={tinaField(data, 'tag')}>
                        {data?.tag}
                    </span>
                </div>
                <div className='row'>
                    ...
                    <div className='col-lg-8 col-sm-10 col-12 text-center'>
                        <h2 className='text-heading-1 color-gray-900' data-tina-field={tinaField(data, 'heading1')}>
                            {data?.heading1}
                        </h2>
                        <p
                        ...
                        <div className='col-lg-4 col-sm-12' key={i}>
                            <div className='card-grid-style-3 pb-40 bg-5 mb-30'>
                                <div className='grid-1-img'>
                                    <img src={card?.image} alt='Agon' data-tina-field={tinaField(card, 'image')} />
                                </div>
                                <h3 className='text-heading-3 mt-20' data-tina-field={tinaField(card, 'heading1')}>
                                    {card?.heading1}
                                </h3>
                                <p className='text-body-excerpt mt-20' data-tina-field={tinaField(card, 'heading2')}>
                                    {card?.heading2}
                                </p>
                                <div className='mt-30'>
