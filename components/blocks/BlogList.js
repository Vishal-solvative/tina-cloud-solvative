            ...
            <div className='container mt-30'>
                <div className='row'>
                    <div className='col-lg-8'>
                        <h3 className='text-heading-1 mb-10' data-tina-field={tinaField(data, 'primaryHeading')}>
                            {data?.primaryHeading}
                        </h3>
                        <p
                    ...
                    {data?.blogList?.map((blog, index) => (
                        <div key={index} className='col-lg-4 col-sm-12 pr-30'>
                            <div className='card-grid-style-4'>
                                <span className='tag-dot' data-tina-field={tinaField(blog?.blog, 'blogTag')}>
                                    {blog?.blog?.blogTag}
                                </span>
                                <Link href={`blogs/${blog?.blog?._sys?.filename || '#'}`} legacyBehavior>
                                    <a
