            ...
            <div className='container mt-120'>
                <div className='row'>
                    ...
                    <div className='col-lg-6 col-sm-12 block-we-do-2'>
                        ...
                        <h3 className='text-heading-1 mt-30' data-tina-field={tinaField(data, 'heading1')}>
                            {data?.heading1}
                        </h3>
                        <p
                        ...
                        <div className='list-icons mt-50'>
                            {data?.ideas?.map((idea, i) => (
                                <div className='item-icon none-bd' key={i}>
                                    <span className='icon-left'>
                                        <img src={idea?.image} alt='Agon' data-tina-field={tinaField(idea, 'image')} />
                                    </span>
                                    <h4 className='text-heading-4' data-tina-field={tinaField(idea, 'title')}>
                                        {idea?.title}
                                    </h4>
                                    <p
