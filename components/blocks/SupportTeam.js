    ...
    return (
        <section className='section-box mt-100'>
            <div className='container text-center'>
                <h3 className='text-heading-1 mb-10' data-tina-field={tinaField(data, 'heading1')}>
                    {data?.heading1}
                </h3>
                <p className='text-body-lead-large color-gray-600 mt-30' data-tina-field={tinaField(data, 'heading2')}>
                    {data?.heading2}
                </p>
            </div>
                    ...
                    {data?.members?.map((member, i) => (
                        <div className='col-lg-3 col-md-6 col-12' key={i}>
                            ...
                            >
                                ...
                                <h3 className='text-heading-6 mb-5 mt-20' data-tina-field={tinaField(member, 'name')}>
                                    {member?.name}
                                </h3>
                                <span
